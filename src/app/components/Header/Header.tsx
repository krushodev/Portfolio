  ...
  return (
    <div className="h-full grid grid-rows-6 md:grid-rows-5">
      <div className="flex flex-col gap-5 row-span-4 md:flex-row md:row-span-3 md:justify-between">
        <h2 className="text-4xl font-medium uppercase break-words sm:text-5xl s:w-3/4 lg:w-2/4 lg:text-7xl xl:text-8xl 2xl:text-9xl">Fullstack Developer</h2>
      ...
      <div className="flex justify-between items-end row-span-2 sm:flex-row sm:justify-between">
        <ScrollDownIndicator />
        <h1 className="w-3/4 text-2xl text-right font-medium uppercase xs:text-3xl s:w-96 sm:text-right sm:text-4xl sm:w-4/6 lg:text-6xl xl:text-7xl 2xl:w-8/12 2xl:text-8xl">
          Ignacio
          <br />
          Kruchowski
        </h1>

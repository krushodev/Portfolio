      ...
      <div className="grid grid-flow-row lg:grid-cols-6 lg:gap-5">
        <div className="lg:col-span-2 xl:col-span-2 flex flex-col">
          <div className="space-y-4">
            <h4 className="text-lg xxs:text-xl font-bold uppercase tracking-wide">Languages</h4>
            <div>
        ...
        <div className="row-span-4 s:row-span-6 lg:col-span-4">
          <div className="space-y-4">
            <h4 className="text-lg xxs:text-xl font-bold uppercase tracking-wide">Frameworks / Libraries / Others</h4>
            <div>
